        ...
        if Intento['tag'] == Etiqueta:
            ...
            if Intento['tag'] == "fecha":
                ...
                return [
                    ...
                    '<img decoding="async" width="120" class="elemento_interno" src="horario.gif" alt="">',
                    '<b>También puedes consultar</b>'
                        ...
                        '<section class="card">'
                            '<header>'
                                '<p>'
                                    ...
                                    '\n<button class="info" onclick="Mostrar(\'Subdirección Administrativa\')">Subdirección Administrativa</button> \n ➡️ Cualquier otro activo'
                                '</p>'
                            '</header>'
                        '</section>'
                    '</div>',
